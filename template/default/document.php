						...
						<div class="card">
							<div class="card-body">
								<div>
								 ...
								 <a href="../doc.php?act=ini" "target="_blank" class="btn btn-link btn-sm">
						        [API]应用配置</a>
                                 <a href="../doc.php?act=notice" "target="_blank" class="btn btn-link btn-sm">
						        [API]应用公告</a>
                                 <a href="../doc.php?act=kmlogon" "target="_blank" class="btn btn-link btn-sm">
						        [API]卡密登录</a>
                                 <a href="../doc.php?act=kmunmachine" "target="_blank" class="btn btn-link btn-sm">
						        [API]卡密解绑</a>
                                 <a href="../doc.php?act=getfile" "target="_blank" class="btn btn-link btn-sm">
						        [API]获取文件外链</a>
