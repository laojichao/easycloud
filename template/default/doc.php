		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				<p class="simpleTable">
					...
					<span class="url" data-clipboard-text="<?php echo $_SERVER['REQUEST_SCHEME'].'s://'.$_SERVER['HTTP_HOST'].'/api.php?api='.$_GET['act'];?>">
						<?php echo $_SERVER['REQUEST_SCHEME'].'s://'.$_SERVER['HTTP_HOST'].'/api.php?api='.$_GET['act'];?>
					</span>
				</p>
				<p class="simpleTable">
				...
				<p class="simpleTable">
					...
					<span class="url" data-clipboard-text="<?php echo $_SERVER['REQUEST_SCHEME'].'s://'.$_SERVER['HTTP_HOST'].'/api.php?api='.$_GET['act'].'&app=10000';?>">
						<?php echo $_SERVER['REQUEST_SCHEME'].'s://'.$_SERVER['HTTP_HOST'].'/api.php?api='.$_GET['act'].'&app=10000';?>
					</span>
				</p>
				...
				<table class="layui-table" lay-size="sm">
					...
					<tbody>	
			   		<?php include_once 'doc/'.$_GET['act'].'/request.html';?>
					</tbody>
				</table>
				...
				<table class="layui-table" lay-size="sm">
					...
					<tbody>
					<?php include_once 'doc/'.$_GET['act'].'/return.html';?>
					</tbody>
				</table>
				<p class="linep">返回示例：</p>
				<pre class="layui-code"><?php include_once 'doc/'.$_GET['act'].'/demo.html';?></pre>
			</div>
			<div class="layui-tab-item">
				...
				<table class="layui-table" lay-size="sm">
					...
					include_once 'doc/'.$_GET['act'].'/error.html';
					?>
					</tbody>
				</table>
			</div>
			<div class="layui-tab-item">
				...
				<pre class="layui-code"><?php include_once 'doc/'.$_GET['act'].'/example.html';?></pre>
			</div>
		</div>
	</div>
</div>
