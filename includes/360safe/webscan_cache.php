...
$webscan_white_url = array('set.php' => 'mod=site_n', '/set.php' => 'mod=gonggao_n', 'shopedit.php' => 'mod=edit_submit', '/shopedit.php' => 'mod=add_submit', 'message.php' => 'mod=add_submit', '/message.php' => 'mod=edit_submit', '/uset.php' => 'mod=site_n');
?>